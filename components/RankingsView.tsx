...
import { LogoIcon, TrophyIcon, UserIcon, ShieldCheckIcon, StarIcon, SparklesIcon } from './icons';
...
const RankingsView: React.FC<RankingsViewProps> = ({ onBack }) => {
    ...
    const LeaderboardRow: React.FC<{user: LeaderboardUser}> = ({ user }) => (
        <tr key={user.id} className="hover:bg-gray-800/50 transition-colors">
            <td className="p-4 text-center font-bold text-white w-16">{user.rank}</td>
            <td className="p-4">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-sm text-gray-400">{user.mainVibe}</p>
                        </div>
                    </div>
                </div>
            </td>
